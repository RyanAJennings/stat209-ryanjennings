...
**Answer**: This is the average rate at which a crime resulted in an arrest. (0 - false, 1 - true) This means that 17.2482% of crimes result in arrest.
...
**Answer**: This is the average rate at which a crime is classified as a theft. (0 - false, 1 - true) This means that 27.51659% of crimes are thefts.
...
**Answer**: This is the total number of crimes in the dataset that are classified as thefts.
...
**Answer**: This means that 36.55238 theft crimes occur per 1000 households.
...
**Answer**: This is slightly larger than the mean of the arrest flag over the entire dataset. Yes, we can compare these measurements - the mean of the arrest flag over the entire dataset is the average rate that crimes result in arrest over a large area, while the mean of the arrest flag that was just calculated only looks at a certain area. This can be used to determine if crimes more (or less) often result in arrest in a certain area when compared to the "bigger picture" or the larger area.
...
**Answer**: This is slightly larger than the mean of the theft flag over the entire dataset. Yes, we can compare these measurements - while the mean over the entire dataset tells us the rate at which crimes are classified as thefts, the mean over this area tells us the rate at which crimes only in this areas are classified as thefts. We can use this to determine whether more (or less) crimes in a certain area (in this case, area 23) are classified as thefts than those in the overall dataset.
...
**Answer**: This is larger than the number of thefts per 1000 households over the entire dataset. We can safely compare this number to the overall number of thefts per 1000 households over the entire dataset because we have normalized it.
